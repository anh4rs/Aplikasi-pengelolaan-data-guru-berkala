...
<body>
    ...
    <div class="container">
        <div class="isi">
        <h2 style="text-align:center;text-transform: uppercase;">DATA BERKALA KESELURUHAN</h2>
                <table  class="table table-bordered table-hover">
                        ...
                        <tbody>
                            @foreach($dataBerkala as $p)
                            <tr>
                                <td>{{ $loop->iteration }}</td>
                                <td>{{ $p->guru->nama }}</td>
                                <td>{{ $p->guru->NIP }}</td>
                                <td>{{ $p->perihal }}</td>
                                <td>{{ $p->no_keputusan }}</td>
                                <td>{{ $p->gaji_baru }}</td>
                                <td>
                                    @if($p->status == 1)
                                        <label for="" class="text-primary">Diterima</label>
                                    @else
                                        <label for="" style="color:red;">Ditolak</label>
                                    @endif
                                </td>
                            </tr>
                            @endforeach
